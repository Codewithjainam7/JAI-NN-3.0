  ...
  return (
    <div className="min-h-screen w-full bg-black text-white font-sans overflow-y-auto selection:bg-indigo-500/30 relative">
      ...
      <nav className="relative z-20 max-w-5xl mx-auto px-6 py-8 flex items-center justify-between">
         ...
         <div className="flex items-center gap-2 text-xl font-bold tracking-tight animate-fade-in font-mono opacity-50">
             JAI-NN_CREATOR
         </div>
      </nav>

      <div className="relative z-10 max-w-4xl mx-auto px-6 pb-20 pt-10">
         <div className="smoked-glass p-8 md:p-16 rounded-[48px] border border-white/10 shadow-2xl shadow-indigo-900/10 animate-slide-up">
            ...
            <div className="flex flex-col md:flex-row items-center gap-10 md:gap-16 mb-12">
                ...
                <div className="relative shrink-0 group">
                   ...
                   <div className="absolute bottom-2 right-2 md:bottom-4 md:right-4 w-10 h-10 bg-indigo-600 rounded-full flex items-center justify-center border-4 border-black text-white shadow-lg animate-bounce delay-1000">
                ...
                <div className="text-center md:text-left flex-1">
                    ...
                    <div className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full bg-indigo-500/10 text-indigo-400 text-sm font-mono border border-indigo-500/20 mb-8 animate-slide-up" style={{ animationDelay: '0.2s' }}>
                    ...
                    <div className="flex items-center justify-center md:justify-start gap-4 animate-slide-up" style={{ animationDelay: '0.3s' }}>
                        ...
                        <a 
                          ...
                          target="_blank" 
                          rel="noreferrer" 
                          className="px-8 py-3 bg-white text-black rounded-full text-xs font-bold font-mono tracking-widest hover:bg-indigo-500 hover:text-white transition-all hover:scale-105 duration-300 shadow-[0_0_20px_rgba(255,255,255,0.2)]"
                        >
                            VIEW_PORTFOLIO
                        </a>
                    </div>
