...
interface IconProps {
  name: 'logo' | 'send' | 'stop' | 'plus' | 'menu' | 'image' | 'settings' | 'copy' | 'play' | 'chevron-down' | 'check' | 'trash' | 'mic' | 'lock' | 'sparkles' | 'github' | 'google' | 'edit' | 'download' | 'thumbs-up' | 'thumbs-down' | 'refresh' | 'home' | 'panel-left' | 'cpu' | 'x' | 'code' | 'zap' | 'shield' | 'globe' | 'users' | 'arrow-right' | 'paperclip' | 'brain' | 'robot' | 'palette' | 'volume';
  className?: string;
  size?: number;
}
...
export const Icon: React.FC<IconProps> = ({ name, className = "", size = 20 }) => {
  ...
  const icons: Record<string, React.ReactElement> = {
    ...
    'thumbs-down': <path strokeLinecap="round" strokeLinejoin="round" d="M7.5 15h2.25m8.024-9.75c.011.05.028.1.052.148.591 1.2.924 2.55.924 3.977a8.96 8.96 0 0 1-.999 4.125m.023-8.25c-.076-.365.183-.75.575-.75h.908c.889 0 1.713.518 1.972 1.368.339 1.103.525 2.29.525 3.508 0 1.218-.186 2.405-.525 3.508-.259.85-1.083 1.368-1.972 1.368h-.908c-.392 0-.651-.385-.575-.75M15 13.5c0 1.092-.414 2.088-1.095 2.839A3.75 3.75 0 0 1 12 18a3.75 3.75 0 0 1-1.905-1.661A3.75 3.75 0 0 1 9 13.5V8.197" />,
    ...
    paperclip: <path strokeLinecap="round" strokeLinejoin="round" d="m18.375 12.739-7.693 7.693a4.5 4.5 0 0 1-6.364-6.364l10.94-10.94A3 3 0 1 1 19.5 7.372L8.552 18.32m.009-.01-.01.01m5.699-9.941-7.81 7.81a1.5 1.5 0 0 0 2.112 2.13" />,
    brain: <path strokeLinecap="round" strokeLinejoin="round" d="M12 18v-5.25m0 0a6.01 6.01 0 0 0 1.5-.189m-1.5.189a6.01 6.01 0 0 1-1.5-.189m3.75 7.478a12.06 12.06 0 0 1-4.5 0m3.75 2.383a14.406 14.406 0 0 1-3 0M14.25 18v-.192c0-.983.658-1.823 1.508-2.316a7.5 7.5 0 1 0-7.517 0c.85.493 1.509 1.333 1.509 2.316V18" />,
    robot: <path strokeLinecap="round" strokeLinejoin="round" d="M17.982 18.725A7.488 7.488 0 0 0 12 15.75a7.488 7.488 0 0 0-5.982 2.975m11.963 0a9 9 0 1 0-11.963 0m11.963 0A8.966 8.966 0 0 1 12 21a8.966 8.966 0 0 1-5.982-2.275M15 9.75a3 3 0 1 1-6 0 3 3 0 0 1 6 0Z" />,
    ...
    volume: <path strokeLinecap="round" strokeLinejoin="round" d="M19.114 5.636a9 9 0 0 1 0 12.728M16.463 8.288a5.25 5.25 0 0 1 0 7.424M6.75 8.25l4.72-4.72a.75.75 0 0 1 1.28.53v15.88a.75.75 0 0 1-1.28.53l-4.72-4.72H4.51c-.88 0-1.704-.507-1.938-1.354A9.01 9.01 0 0 1 2.25 12c0-.83.112-1.633.322-2.396C2.806 8.756 3.63 8.25 4.51 8.25H6.75Z" />,
  };
